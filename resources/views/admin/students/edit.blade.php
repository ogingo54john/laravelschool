  ...
  <!-- Main content -->
    <section class="content">
      <div class="container-fluid">
        ...
        <form class="mt-3" autocomplete="off" method="post" action="{{ route("create_student") }}" novalidate="novalidate" enctype="multipart/form-data">
        @csrf
        ...
        <input type="email" name="email" value="{{ old("email") }}" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Enter Student Email">
        @error('email')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
       ...
       <div class="form-group col-md-6">
        ...
        <input type="number" step="0.0" min="1"  name="admission_number" class="form-control @error('admission_number') is-invalid @enderror" id="admission_number" placeholder="Enter Student Admission number">
