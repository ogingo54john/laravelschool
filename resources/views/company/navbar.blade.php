        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2 my-auto d-none d-sm-none d-md-block d-lg-block">
                    <h5 class="brand-name" style="cursor:pointer" onclick="document.location.href ='/';">Nyagaka Agency</h5>
                </div>
                ...
                <div class="col-md-5 my-auto">
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item dropdown">
                         ...
                         <img src="/userprofiles/{{  Auth::user()->userProfile->image }}" class="rounded-circle" height="30px" width="30px" alt="  {{ Auth::user()->name }}">
                                @endif
                           <img src="/userprofiles/placeholder.png" class="rounded-circle" height="30px" width="30px" alt="  {{ Auth::user()->name }}">
                               --}}
                                {{ Auth::user()->name }}
                            </a>
