...
Route::controller(BranchesController::class)->group(function () {
    ...
    Route::controller(StaffController::class)->group(function () {
        ...
        Route::put('/staff/{id}/edit', 'update');
        Route::post('/deletestaff/{userId}/{id}', 'destroy');
        });
...
Route::prefix("student")->middleware(["auth", "isStudent"])->group(function(){
    ...
    Route::get('/profile/create', [App\Http\Controllers\Student\ProfileController::class, 'create']);
});
